...
Below, you can see the built-in Python functions `ord` and `chr` that help us determine what character corresponds to a certain ASCII code and what ASCII code a character has.
